...
myGame.Map.prototype = {
  ...
  create: function() {
    ...
    var block2 = game.add.image(0,0,"mapBlock");
    var block3 = game.add.image(0,0,"aboutBlock");
   ...
   // group3.add(char3);
    ...
    btn.events.onInputDown.add(function (e, pointer) {
      var index = slider.getCurrentIndex();
      if (index == 0) {
        this.state.start('GamePlay1', true, false, 'China', 500, 3, 3, 10, 20);
      } else if (index == 1) {
        this.state.start('GamePlay1', true, false, 'tutorial', 1000, 1, 20, 3.5, 5);
...
//     this.state.start('GamePlay1', true, false, 'China', 1000, 3, 100, 10);
//   },
//   startGame: function() {
